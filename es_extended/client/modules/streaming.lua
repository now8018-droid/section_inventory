...
function ESX.Streaming.RequestStreamedTextureDict(textureDict, cb)
	...
	while not HasStreamedTextureDictLoaded(textureDict) do Wait(50) end
...
function ESX.Streaming.RequestNamedPtfxAsset(assetName, cb)
	...
	while not HasNamedPtfxAssetLoaded(assetName) do Wait(50) end
...
function ESX.Streaming.RequestAnimSet(animSet, cb)
	...
	while not HasAnimSetLoaded(animSet) do Wait(50) end
